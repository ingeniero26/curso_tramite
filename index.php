...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="index.php" class="h1"><b>Admin</b>TRÁMITE</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">DATOS DE INGRESO </p>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Contraseña" id="txt_clave">
          <div class="input-group-append">
            <div class="input-group-text">
      ...
      <p class="mb-1">
        <a href="forgot-password.html">Recuperar Clave</a>
      </p>
      <p class="mb-0">
