...
<head>
  ...
  <title>Tramite Documentos</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <a class="dropdown-item" href="../controller/usuario/cntrlCerrarSesion.php"><i class="fa fa-power-off"></i>Cerrar Sesión</a>
        </div>
      </li>
      <li class="nav-item">
  ...
  <div class="content-wrapper" id="contenido_principal">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Admin Principal</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
